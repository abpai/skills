...
- [ ] Read `WALKTHROUGH_NOTES.md` at repo root **first** if present — owner framing, treated as authoritative (see `code/skills/code/walkthrough.md` Step 0). Quote it later when stops turn on owner-stated framing.
