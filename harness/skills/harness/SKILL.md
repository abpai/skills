---
name: harness
description: Agent harness workflow pack. Use /harness:docs in Claude or $harness docs in Codex to create progressive-disclosure repository docs: tiny AGENTS.md routers, docs/INDEX.md, docs/GLOSSARY.md defined terms, compact architecture maps, engineering commands/testing/observability docs, design-system guidance, docs/todos specs, and per-domain code maps, invariants, and validation routes.
argument-hint: "[subcommand] [args] - e.g. docs, --docs docs overhaul"
metadata:
  version: "1.0.3"
---
...
Known subcommands: `docs`.

Reserved future workflows: `doctor`, `testing`, `reflect`. Do not route to them until their modules exist. Evals stay outside the docs structure unless a dedicated workflow is added later.
