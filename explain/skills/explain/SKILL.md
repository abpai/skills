...
name: explain
description: >
  Write high-density, progressive-disclosure explanations that build understanding
  one layer at a time.
when_to_use: >
  Use when the user asks to explain, break down, walk through, teach, draft a
  guide, tutorial, README walkthrough, onboarding doc, blog post, essay, or
  internal explainer, or when any concept needs to be turned into clear,
  scannable, no-fluff prose. Also fits "ELI5 but for engineers," "clear
  explainer," or "how does X work?"
argument-hint: "[topic, draft, or concept to explain]"
metadata:
  author: Andy Pai
  version: "1.1.0"
  tags: "writing technical-writing explanation tutorial onboarding progressive-disclosure"
---
...
Target shape: [references/output-example.md](references/output-example.md).
